...
-- CreateIndex
CREATE UNIQUE INDEX "ShoppingListItem_userId_storeProductId_key" ON "ShoppingListItem"("userId", "storeProductId");
...
-- AddForeignKey
ALTER TABLE "ShoppingListItem" ADD CONSTRAINT "ShoppingListItem_storeProductId_fkey" FOREIGN KEY ("storeProductId") REFERENCES "StoreProduct"("id") ON DELETE CASCADE ON UPDATE CASCADE;
